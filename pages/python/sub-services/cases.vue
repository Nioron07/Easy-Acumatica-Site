...
useSeoMeta({
  title: 'Cases Service | Acumatica API for Support Cases',
  description: 'Manage Acumatica support cases programmatically with Easy-Acumatica. Create new cases, link related issues, and update case properties via API.',
  // OG Image and Twitter Image will be generated by defineOgImage
  ogImage: 'https://www.easyacumatica.com/social-images/home.png', // This is the default path Nuxt OG Image uses
  twitterCard: 'summary_large_image',
  twitterTitle: 'Acumatica Cases API with Easy-Acumatica',
  twitterDescription: 'Automate Acumatica support case management. Python & Node.js API wrappers.',
  twitterImage: 'https://www.easyacumatica.com/social-images/home.png', // Use the same generated URL
});

defineOgImage({
  title: 'Acumatica Cases Service',
  description: 'Programmatically create, link, and manage support cases via API with Easy-Acumatica.',
});
